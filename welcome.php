...
<h5><?php echo "Welcome ". $_SESSION['username']?>! You can now use this website</h5>
<hr>
</div -->
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption d-none d-md-block">
            <h5 style="font-size:40px;"><?php echo "Welcome "."'". $_SESSION['username']."'"?> to the best restaurant in the world</h5>
